...
contract Setup {
    ...
    AvailDataAvailabilityChallenge availDataAvailabilityChallenge;
    ...
    function L1() public {
        ...
        if (deploy.cfg().usePlasma()) {
            if (deploy.cfg().useAvailPlasma()) {
                availDataAvailabilityChallenge =
                    AvailDataAvailabilityChallenge(deploy.mustGetAddress("DataAvailabilityChallengeProxy"));
                vm.label(address(availDataAvailabilityChallenge), "DataAvailabilityChallengeProxy");
