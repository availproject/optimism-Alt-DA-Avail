...
contract DeployConfig is Script {
    ...
    function read(string memory _path) public {
        ...
        useAvailPlasma = _readOr(_json, "$.useAvailPlasma", false);
    ...
    function setAvailUsePlasma(bool _useAvailPlasma) public {
        useAvailPlasma = _useAvailPlasma;
    }
